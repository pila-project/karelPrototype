      ...
      <div className="vertical centered fullSize">
        <IdeItem
          instructions = {<span>
            ...
            &nbsp;{translate('Although this program solves the problem, not using new commands makes it harder to read')}:
          </span>}
          preWorld = {{
            width:300,
            height:300 * (2/nCols),
