...
const parsonBlocks = {
  'karel_move': {'NAME':'', 'NUMBER': 4}, // NAME: TO BE IMPLEMENTED - Label for the block if another label is to be given than 'move forward'; NUMBER: number of blocks
  'karel_turn_left': {'NAME': '', 'NUMBER': 4},
  'karel_pickup_stone': {'NAME': '', 'NUMBER': 2},
  'karel_place_stone': {'NAME': '', 'NUMBER': 0},
