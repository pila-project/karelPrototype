...
import {Prolific, Parson, MultipleWorlds, Tutorial, Experience1, Experience2, KarelMap2} from './TaskSequences'
...
export default class Curriculum {
  ...
  constructor(moduleName) {
    ...
    } else if (moduleName.toLowerCase() == 'karelmap2') {
      this.pre = KarelMap2.getPre()
      this.post = KarelMap2.getPost()
      this.learningPlan = KarelMap2.getLearningPlan()
