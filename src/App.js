...
import { ManageModules, Parson, Prolific, Experience1, Experience2, KarelMap2, MultipleWorlds, Tutorial} from './Pages'
  ...
  render() {
    return (
      ...
      <div>
        ...
        <Route exact path="/karelmap2" component={ManageModules} />
        <Route exact path="/karelmap2/:userId" component={ManageModules} />
