...
const fr = {
  ...
  'Write a program from scratch that makes Karel move to the position shown in the "Goal" world':'Écrivez un programme à partir de zéro qui fait passer Karel à la position indiquée dans le monde "Goal"',
  'This example program makes Karel walk out of her house':'Cet exemple de programme fait sortir Karel de sa maison',
  'It is broken since the commands are outside the define block':'Il est cassé car les commandes sont en dehors du bloc define',
  ...
  "Big Challenge Problem #1": "Gros Problème de Défi #1",
  "Big Challenge Problem #2": "Gros Problème de Défi #2",
  "Teach 1": "Enseigner 1",
  "Teach 2": "Enseigner 2",
  "Repeat 1": "Répétez 1",
  "Repeat 2": "Répétez 2",
  ...
  'This program has karel pick up a stone and move it around a corner. It creates a new command to "turn right"':
    'Ce programme demande à Karel de ramasser une pierre et de la déplacer dans un coin. Il crée une nouvelle commande pour "tourner à droite"',
  ...
  "clickMoveHelp":"Cliquez sur ce bouton pour faire advancer Karel",
  ...
  'Add another move to the program':'Ajouter un autre "advancer" au programme',
